...
import { Code2, ArrowRight, MessageSquare, Cpu, FileText, ShieldCheck } from 'lucide-react';
    ...
    <div className={s.page}>
      ...
      <main className={s.pageHeaderSub}>
        ...
        <p className={s.lead} style={{ maxWidth: '620px', margin: '0 auto 3rem' }}>
          Todo lo que necesitás saber sobre cómo funciona ScopeProfit, la integración con Telegram,
          el modelo de IA y la protección contra el scope creep.
        </p>
        ...
        >
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem', margin: '0 0 1.5rem' }}>
            Podés crear tu cuenta gratis en menos de un minuto y probar el flujo con tu primer
            proyecto.
          </p>
      ...
      <footer className={s.footerCompact} style={{ marginTop: '5rem' }}>
        <div className={s.footerCompactInner}>
          ...
          <nav className={s.footerCompactNav}>
            ...
            <Link href="/#flujo-exacto" className={s.footerCompactLink}>
              Paso a paso
            </Link>
            <Link href="/#anatomia-documento" className={s.footerCompactLink}>
              El Entregable
            </Link>
            <Link href="/status" className={s.footerCompactLink}>
              Estado
            </Link>
            <a
