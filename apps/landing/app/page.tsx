...
export default function Home() {
  ...
  const handleCopyWhatsapp = () => {
    if (typeof navigator !== 'undefined' && navigator.clipboard) {
      navigator.clipboard
        .writeText(
          'Hola Juan! Para cotizar tu app sin idas y vueltas, contale tu idea a nuestro bot de Telegram: mandale audios o capturas acá https://t.me/ScopeProfitBot?start=tok_b2b_9918a',
        )
        .catch(() => {});
    }
  ...
  const handleDownload = (type: 'pdf' | 'docx') => {
    const name =
      type === 'pdf' ? 'Alcance_Blindado_ScopeProfit.pdf' : 'Alcance_Editable_ScopeProfit.docx';
  ...
  const handleCopyLink = () => {
    if (typeof navigator !== 'undefined' && navigator.clipboard) {
      navigator.clipboard
        .writeText('https://t.me/ScopeProfitBot?start=tok_b2b_9918a')
        .catch(() => {});
    }
    setCopiedLink(true);
    ...
    <div className={s.page} ref={heroRef}>
      ...
      <section className={s.hero}>
        <div className={s.heroContent}>
          ...
          <p className={s.lead}>
            ...
            <strong> especificación técnica blindada</strong> — con lo que incluye, lo que NO
            incluye y zonas grises identificadas antes de escribir una sola línea de código.
          </p>
          ...
          <div id="que-hace" className={s.explainerBox}>
            ...
            <div className={s.explainerText}>
              ...
              <p>
                ...
                especializado le repregunta los <strong>puntos ciegos y zonas grises</strong> que
                vos no tenés tiempo de indagar, y genera un{' '}
                <strong>
                  documento formal (con lo que incluye, lo que NO incluye, riesgos y horas)
                </strong>{' '}
                en PDF y Word editable para que firme antes de programar.
              </p>
            </div>
          </div>
        ...
        <div id="workbench" className={s.workbench} ref={workbenchRef}>
          <div className={s.workbenchHeader}>
            ...
            <span className={s.workbenchPath}>
              scopeprofit-runtime · simulador de proyecto en vivo
            </span>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    <span
                      className={s.workbenchActorPill}
                      style={{
                        background: 'rgba(234, 40, 69, 0.15)',
                        color: '#ea2845',
                        border: '1px solid rgba(234, 40, 69, 0.3)',
                      }}
                    >
                      💻 Vos (El Desarrollador o Agencia)
                    </span>
                    <span style={{ fontSize: '0.8rem', color: 'var(--text-dim)' }}>
                      Hito 01 · Crear proyecto
                    </span>
                  </div>
                  <span
                    style={{
                ...
                <div>
                  ...
                  >
                    Tu cliente no tiene que crearse una cuenta ni aprender herramientas nuevas. Vos
                    le enviás un link privado de Telegram con un mensaje prediseñado para WhatsApp o
                    Slack.
                  </p>
                </div>
                ...
                >
                  ...
                  >
                    <div>
                      ...
                      >
                        &quot;Hola Juan! Para cotizarte la app sin reuniones eternas, contale tu
                        idea a nuestro bot de Telegram: mandale audios o capturas acá:{' '}
                        <span style={{ color: '#38bdf8' }}>t.me/ScopeProfitBot...</span>&quot;
                      </div>
                    </div>
                    <button
                      type="button"
                      ...
                      style={{
                        background: copiedWhatsapp
                          ? 'rgba(52, 211, 153, 0.2)'
                          : 'rgba(234, 40, 69, 0.15)',
                        border: copiedWhatsapp
                          ? '1px solid rgba(52, 211, 153, 0.4)'
                          : '1px solid rgba(234, 40, 69, 0.3)',
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    ...
                    <span style={{ fontSize: '0.8rem', color: 'var(--text-dim)' }}>
                      Hito 02 · Cero fricción (0 logins requeridos)
                    </span>
                  </div>
                  <span
                    style={{
                    ...
                    <div style={{ flex: 1 }}>
                      <div className={s.chatBubble}>
                        <div style={{ marginBottom: '0.5rem' }}>
                          Hola! Necesitamos armar una app rápida para nuestros distribuidores.
                          Básicamente que puedan ver el catálogo, hacer pedidos en cuenta corriente
                          y tener un panel de métricas estándar.
                        </div>
                        ...
                        <div className={s.chatVoice}>
                          ...
                          <div className={s.voiceWave}>
                            {[12, 18, 8, 22, 14, 24, 10, 16, 20, 12, 18, 9, 21, 15, 23, 11].map(
                              (h, i) => (
                                <span
                                  key={i}
                          ...
                          <div
                            style={{
                              ...
                              fontFamily: 'ui-monospace, monospace',
                              fontSize: '0.78rem',
                              color: isPlayingAudio ? '#ea2845' : 'var(--text-muted)',
                            }}
                          >
                        ...
                        >
                          {isPlayingAudio
                            ? '▶ Reproduciendo audio del cliente...'
                            : 'Clic en Play para simular la reproducción del audio'}
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{
                        ...
                        borderColor: 'rgba(234, 40, 69, 0.25)',
                      }}
                    >
                      ¡Anotado! Para proteger la cotización y los plazos, necesitamos definir tres
                      puntos críticos:
                      <br />
                      <strong>1.</strong> ¿Los distribuidores pagan en la app (Stripe/MercadoPago) o
                      con cuenta corriente previa?
                      <br />
                      <strong>2.</strong> ¿Quién realiza la carga inicial de los productos y listas
                      de precios?
                      <br />
                      <strong>3.</strong> ¿El stock debe sincronizarse en tiempo real con su ERP
                      actual o mediante planillas?
                    </div>
                  </div>
                </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    ...
                    <span style={{ fontSize: '0.8rem', color: 'var(--text-dim)' }}>
                      Hito 03 · Detección de riesgos antes de cotizar
                    </span>
                  </div>
                  <span
                    style={{
                ...
                <div className={s.engineSimulation}>
                  <div className={s.engineRow}>
                    <span className={`${s.engineBadge} ${s.badgeAmbiguity}`}>
                      AMBIGÜEDAD [ALTA]
                    </span>
                  ...
                  <div className={s.engineRow}>
                    <span className={`${s.engineBadge} ${s.badgeRequirement}`}>
                    ...
                    <div className={s.engineDetails}>
                      ...
                      <p>
                        ...
                        WhatsApp como opcional cotizable.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    ...
                    <span style={{ fontSize: '0.8rem', color: 'var(--text-dim)' }}>
                      Hito 04 · Human-in-the-loop estricto
                    </span>
                  </div>
                  <span
                    style={{
                ...
                >
                  <div
                    style={{
                      ...
                      justifyContent: 'space-between',
                      alignItems: 'center',
                      borderBottom: '1px solid var(--nest-card-border)',
                      paddingBottom: '1rem',
                      marginBottom: '1rem',
                      flexWrap: 'wrap',
                      gap: '0.75rem',
                  ...
                  >
                    <div>
                      ...
                      >
                        BORRADOR GENERADO // LISTO PARA TU REVISIÓN
                      </span>
                      <div
                        style={{ fontSize: '1.05rem', fontWeight: 700, color: 'var(--text-white)' }}
                      >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        • Catálogo y precios mayoristas
                        <br />
                        • Pedidos en cuenta corriente
                        <br />• Roles Admin y Distribuidor
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <div
                        style={{ fontSize: '0.82rem', color: 'var(--text-muted)', lineHeight: 1.5 }}
                      >
                        • Pasarela de cobros online
                        <br />
                        • Carga masiva de inventario
                        <br />• App móvil iOS nativa
                      </div>
                    </div>
                  </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    ...
                    <span style={{ fontSize: '0.8rem', color: 'var(--text-dim)' }}>
                      Hito 05 · Listo para firma y cierre
                    </span>
                  </div>
                  <span
                    style={{
                ...
                <div className={s.specSimulation}>
                  <div className={s.specHeader}>
                    <div>
                      ...
                      >
                        SPEC_ID: PRJ-84920 // STATUS: READY_TO_SIGN
                      </span>
                      <div className={s.specTitle}>
                        Alcance de Proyecto — Portal B2B ({estimatedHours} Horas Acordadas)
                      </div>
                    </div>
      ...
      <section id="flujo-exacto" className={s.section}>
        <div className={s.sectionHeader}>
          ...
          <p className={s.sectionSubtitle}>
            Así interactuás vos, tu cliente y ScopeProfit desde el día cero hasta que cobrás tu
            presupuesto:
          </p>
        </div>
        ...
        <div className={s.timelineWrapper}>
          ...
          <div className={s.timelineItem}>
            ...
            <div className={s.timelineCard}>
              <span className={s.cardCornerGlint} style={{ color: '#ea2845' }}>
                ✦
              </span>
              ...
              <h3 className={s.timelineTitle}>
                Creás el proyecto y obtenés el link para tu cliente
              </h3>
              <p className={s.timelineDesc}>
                Entrás a tu panel y creás el proyecto (o simplemente mandás{' '}
                <code>/createproject NombreCliente</code> a nuestro bot de Telegram). ScopeProfit te
                entrega un enlace de invitación privado y exclusivo para ese cliente.
              </p>
              ...
              <div className={s.timelineMockBox}>
                ...
                <div className={s.timelineMockCopyRow}>
                  <span className={s.timelineMockLink}>
                    t.me/ScopeProfitBot?start=tok_b2b_9918a
                  </span>
                  <button
                    type="button"
                ...
                >
                  &quot;Hola Juan! Para armarte la propuesta exacta y no perder tiempo en reuniones
                  repetidas, contale tu idea a nuestro bot de Telegram: mandale audios, capturas o
                  textos con lo que tengas en mente.&quot;
                </div>
              </div>
            </div>
          </div>
          ...
          <div className={s.timelineItem}>
            ...
            <div className={s.timelineCard}>
              <span className={s.cardCornerGlint} style={{ color: '#38bdf8' }}>
                ✦
              </span>
              <div className={s.timelineCardHeader}>
              ...
              <h3 className={s.timelineTitle}>
                El cliente cuenta su idea sin fricción (0 registros)
              </h3>
              <p className={s.timelineDesc}>
                Tu cliente hace clic en el enlace desde su teléfono. No tiene que inventar
                contraseñas, ni bajarse software desconocido, ni completar formularios de 20
                preguntas. Empieza a hablar exactamente como habla con cualquier persona.
              </p>
              ...
              <div className={s.timelineMockBox}>
                ...
                <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'center' }}>
                  ...
                  >
                    🎙️ Audio de voz (03:15 min) —{' '}
                    <em>
                      &quot;Mirá, necesitamos un portal donde los clientes vean sus facturas, bajen
                      comprobantes y hagan pedidos en cuenta corriente...&quot;
                    </em>
                  </div>
                </div>
                <div
          ...
          <div className={s.timelineItem}>
            ...
            <div className={s.timelineCard}>
              <span className={s.cardCornerGlint} style={{ color: '#fbbf24' }}>
                ✦
              </span>
              <div className={s.timelineCardHeader}>
              ...
              <h3 className={s.timelineTitle}>
                El agente interroga los puntos ciegos antes de que te exploten
              </h3>
              <p className={s.timelineDesc}>
                No es un chatbot complaciente que dice &quot;sí a todo&quot;. Está entrenado para
                detectar ambigüedades técnicas y hacer las preguntas incómodas que a vos se te pasan
                por alto o te da pereza indagar.
              </p>
              ...
              <div className={s.timelineMockBox}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.45rem' }}>
                  ...
                  >
                    ...
                    <span>
                      <strong>Integración de Stock:</strong> &quot;¿El stock se sincroniza
                      automáticamente con su sistema contable actual o se carga por planilla?&quot;
                    </span>
                  </div>
                  <div
                    style={{
                  ...
                  >
                    <span style={{ color: '#fbbf24' }}>⚠️</span>
                    <span>
                      <strong>Carga Inicial de Datos:</strong> &quot;¿Quién realiza la carga manual
                      de los 2.000 artículos y sus fotografías?&quot;
                    </span>
                  </div>
                  <div
                    style={{
                  ...
                  >
                    <span style={{ color: '#fbbf24' }}>⚠️</span>
                    <span>
                      <strong>Pasarela de Cobro:</strong> &quot;¿Los pagos son con tarjeta en la
                      plataforma o mediante transferencia bancaria contra factura?&quot;
                    </span>
                  </div>
                </div>
              </div>
          ...
          <div className={s.timelineItem}>
            ...
            <div className={s.timelineCard}>
              <span className={s.cardCornerGlint} style={{ color: '#c084fc' }}>
                ✦
              </span>
              <div className={s.timelineCardHeader}>
              ...
              <h3 className={s.timelineTitle}>
                Vos revisás el borrador, editás cláusulas y ponés tus reglas
              </h3>
              <p className={s.timelineDesc}>
                La IA jamás le entrega un presupuesto ni un alcance final a tu cliente por su
                cuenta. Vos recibís el informe clasificado en 6 secciones en tu panel, editás con el
                editor de texto y definís el rango de horas y tarifas.
              </p>
              ...
              <div className={s.timelineMockBox}>
                ...
                >
                  <div style={{ fontSize: '0.85rem' }}>
                    <strong style={{ color: 'var(--text-white)' }}>
                      Borrador v0.4 clasificado:
                    </strong>{' '}
                    8 requerimientos · 3 zonas grises aclaradas · 4 no-objetivos
                  </div>
                  <div
                    style={{
                      background: 'rgba(192, 132, 252, 0.15)',
                ...
                <div style={{ fontSize: '0.78rem', color: 'var(--text-muted)' }}>
                  Ajustás cualquier texto o cláusula legal antes de autorizar la emisión de los
          ...
          <div className={s.timelineItem}>
            ...
            <div className={s.timelineCard}>
              <span className={s.cardCornerGlint} style={{ color: '#34d399' }}>
                ✦
              </span>
              <div className={s.timelineCardHeader}>
              ...
              <h3 className={s.timelineTitle}>
                Descargás el PDF formal y el Word editable para firmar
              </h3>
              <p className={s.timelineDesc}>
                Con un clic descargás el PDF formal con anexo técnico numerado para anexar al
                contrato comercial y el Word (.docx) editable. Tu proyecto arranca blindado: si en
                la semana 4 te piden algo imprevisto, se cobra como orden de cambio.
              </p>
                ...
                <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
                  <div
                    style={{
                      ...
                      minWidth: '180px',
                      background: 'rgba(234, 40, 69, 0.08)',
                      border: '1px solid rgba(234, 40, 69, 0.25)',
                      borderRadius: '8px',
                      padding: '0.65rem 0.85rem',
                    }}
                  >
                    <strong
                      style={{ display: 'block', color: 'var(--text-white)', fontSize: '0.85rem' }}
                    >
                      📄 Alcance-Portal-B2B.pdf
                    </strong>
                    <span style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>
                      PDF formal con índice y firma de conformidad
                    </span>
                  </div>
                  <div
                    style={{
                  ...
                  >
                    <strong
                      style={{ display: 'block', color: 'var(--text-white)', fontSize: '0.85rem' }}
                    >
                      📝 Alcance-Portal-B2B.docx
                    </strong>
                    <span style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>
                      Word editable con estilos para tu agencia
                    </span>
                  </div>
                </div>
              </div>
      ...
      <section id="anatomia-documento" className={s.section}>
        <div className={s.sectionHeader}>
          ...
          <p className={s.sectionSubtitle}>
            Cada alcance generado por ScopeProfit contiene estas 6 secciones contractuales
            estandarizadas:
          </p>
        </div>
        ...
        <div className={s.anatomyGrid}>
          <div className={s.anatomyCard}>
            ...
            <div className={s.anatomySnippet}>
              <strong>Ejemplo en el informe:</strong> &quot;El cliente solicitó en audio de las
              14:20: &apos;Necesitamos que el listado se pueda exportar a Excel para el
              contador&apos;.&quot;
            </div>
          </div>
          ...
          <div className={s.anatomyCard}>
            ...
            <div className={s.anatomyTop}>
              <div
                className={s.anatomyIcon}
                style={{ background: 'rgba(234, 40, 69, 0.15)', color: '#ea2845' }}
              >
                <ShieldAlert size={22} />
              </div>
            </div>
            ...
            <div className={s.anatomySnippet}>
              <strong>Ejemplo en el informe:</strong> &quot;No incluye: Carga manual de los 2.000
              productos existentes ni desarrollo de aplicación móvil para iPhone.&quot;
            </div>
          </div>
          ...
          <div className={s.anatomyCard}>
            ...
            <div className={s.anatomySnippet}>
              <strong>Ejemplo en el informe:</strong> &quot;Se considera terminado cuando el
              administrador pueda dar de alta un producto y recibir confirmación por email en menos
              de un minuto.&quot;
            </div>
          </div>
          ...
          <div className={s.anatomyCard}>
            ...
            <div className={s.anatomySnippet}>
              <strong>Ejemplo en el informe:</strong> &quot;Pendiente de respuesta del cliente:
              &apos;¿Quién nos va a entregar los accesos al servidor antes de comenzar?&apos;&quot;
            </div>
          </div>

          <div className={s.anatomyCard}>
            <span className={s.cardCornerGlint} style={{ color: '#fb923c' }}>
              ✦
            </span>
            <div className={s.anatomyTop}>
              <div
            ...
            <div className={s.anatomySnippet}>
              <strong>Ejemplo en el informe:</strong> &quot;Si la pasarela de pagos demora en
              aprobar la cuenta comercial, la fecha de entrega se corre sin penalización para el
              equipo.&quot;
            </div>
          </div>
          ...
          <div className={s.anatomyCard}>
            ...
            <div className={s.anatomySnippet}>
              <strong>Ejemplo en el informe:</strong> &quot;Módulo de Usuarios y Permisos: estimado
              entre 16 y 22 horas de desarrollo con margen de incertidumbre bajo.&quot;
            </div>
          </div>
        </div>
      </section>
      ...
      <section className={s.section}>
        <div className={s.sectionHeader}>
          ...
          <p className={s.sectionSubtitle}>
            El 85% de los proyectos con pérdidas económicas no fallan por mala programación, sino
            por ambigüedades toleradas en la primera conversación.
          </p>
        </div>
        ...
        <div className={s.problemGrid}>
          <div className={s.problemCard}>
            ...
            <p className={s.problemQuote}>
              &quot;Ah, pero yo asumí que el panel de reportes avanzados venía incluido en el
              precio.&quot;
            </p>
            <p className={s.problemContext}>
              Reunión semana 6: el cliente espera analítica predictiva y gráficos exportables en un
              MVP que cotizaste a precio cerrado.
            </p>
          </div>
          ...
          <div className={s.problemCard}>
            ...
            <p className={s.problemQuote}>
              &quot;Faltan solo estos dos botoncitos y ya salimos a producción, no te cuesta
              nada.&quot;
            </p>
            <p className={s.problemContext}>
              Detrás de esos dos botones hay cambios de arquitectura, nuevas tablas y 30 horas de
              desarrollo que terminás regalando.
            </p>
          </div>
          ...
          <div className={s.problemCard}>
            ...
            <p className={s.problemQuote}>
              &quot;¿Y la migración de los datos viejos quién la hace? Pensé que la hacías
              vos.&quot;
            </p>
            <p className={s.problemContext}>
              Dos semanas antes de entregar, descubrís que nadie limpió una planilla con 40.000
              registros y la fecha de entrega se te viene encima.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="features" className={s.section}>
        <div className={s.sectionHeader}>
          ...
          <p className={s.sectionSubtitle}>
            Cada componente de ScopeProfit fue construido para eliminar fricción y proteger tu
            rentabilidad.
          </p>
        </div>
        ...
        <div className={s.bentoGrid}>
          <div className={s.bentoCard}>
            ...
            <p className={s.bentoText}>
              Conectás tu propia clave de Google Gemini. Pagás el consumo a precio de costo oficial
              del proveedor, sin intermediarios ni suscripciones infladas.
            </p>
          ...
          <div className={s.bentoCard}>
            ...
            <p className={s.bentoText}>
              Tu cliente recibe un PDF sellado listo para firma y vos te quedás con el archivo .docx
              editable con estilos tipográficos para adaptarlo a la identidad de tu agencia.
            </p>
            <div className={s.bentoMicroBadge}>
          ...
          <div className={s.bentoCard}>
            ...
            <div
              ...
              style={{
                background: 'rgba(234, 40, 69, 0.15)',
                color: '#ea2845',
                borderColor: 'rgba(234, 40, 69, 0.3)',
              }}
            >
              <UserCheck size={22} />
            </div>
            ...
            <p className={s.bentoText}>
              La IA te asiste analizando y redactando, pero jamás habla con tu cliente a tus
              espaldas ni emite presupuestos sola. Vos revisás cada punto, editás y aprobás antes de
              emitir.
            </p>
            <div className={s.bentoMicroBadge}>
          ...
          <div className={s.bentoCard}>
            ...
            <p className={s.bentoText}>
              Tu cliente no tiene que crearse usuarios, recordar contraseñas ni aprender
              herramientas complejas. Envía audios o mensajes por Telegram exactamente como
              acostumbra.
            </p>
            <div className={s.bentoMicroBadge}>
          ...
          <div className={s.bentoCard}>
            ...
            <p className={s.bentoText}>
              El motor genera automáticamente la sección &quot;Excluido del Alcance&quot; para
              blindarte legalmente contra pedidos imprevistos o tareas fuera de presupuesto.
            </p>
            <div className={s.bentoMicroBadge}>
          ...
          <div className={s.bentoCard}>
            ...
            <p className={s.bentoText}>
              Cada requerimiento incluye su Definition of Done (DoD) verificable para que no haya
              debates subjetivos sobre cuándo un entregable está terminado.
            </p>
            <div className={s.bentoMicroBadge}>
      ...
      <section className={s.section}>
        <div className={s.finalBanner}>
          ...
          <p>
            Dejá de presupuestar a ciegas. Transformá la próxima charla de Telegram en un alcance
            indiscutible en 12 minutos.
          </p>
          <Link
            href="/login"
            className={s.btnPrimary}
            style={{ padding: '1.1rem 2.2rem', fontSize: '1.1rem' }}
          >
      ...
      <footer className={s.footerCompact}>
        <div className={s.footerCompactInner}>
          ...
          <nav className={s.footerCompactNav}>
            <a href="#flujo-exacto" className={s.footerCompactLink}>
              Paso a paso
            </a>
            <a href="#anatomia-documento" className={s.footerCompactLink}>
              El Entregable
            </a>
            <a href="#features" className={s.footerCompactLink}>
              Capacidades
            </a>
          ...
          <Link
            href="/status"
            className={s.footerStatusLink}
            title="Ver página de estado de servicios"
          >
